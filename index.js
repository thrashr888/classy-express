...
module.exports = function (req, res) {
    ...
    var klassPath = path.join(__dirname, '..', 'classes', klassName);
    var tmplPath = path.join(__dirname, '..', 'templates', klassName + '.jade');
    ...
    if (!fs.existsSync(tmplPath)) {
        tmplPath = path.join(__dirname, '..', 'templates', '404.jade');
    }
    if (!fs.existsSync(tmplPath)) {
